(function (window) {
    ...
    platform.init = function (game) {
        ...
        // example:
        platform.create(550, 500, .03, 7);
        platform.create(0, 525, 1, .4);
        platform.create(450, 590, .18, .3);
        platform.create(650, 525, .34, .4);
        platform.create(700, 450, .53, .4);
        platform.create(620, 600, .7, .4);
